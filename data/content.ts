...
export const uavArchive: ProjectArchive = {
  ...
  overview: {
    ...
    points: [
      ...
      { zh: "證據邊界：戶外實飛、完整實體 strike 與多機協同的驗證狀態，無法由目前公開資料確認；室內聯調是否構成硬體在環亦未在公開檔案中明確分類。精確實驗數值保留在論文脈絡。", en: "Evidence boundary: the current public material cannot confirm the validation status of outdoor flight, full physical strike, or multi-agent operation. The public archive also does not explicitly classify the indoor integration as hardware-in-the-loop. Exact experiment values remain in the thesis context." },
    ],
